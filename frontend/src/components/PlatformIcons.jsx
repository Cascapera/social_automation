/** Ícones SVG das redes sociais para a agenda */
...
/** YouTube (vídeos longos) - play button no retângulo */
...
const ICONS = {
  IG: IconInstagram,
  TT: IconTikTok,
  YT: IconYouTubeShorts,
  YTB: IconYouTube,
}

export function PlatformIcon({ platformId, className = '', title = '' }) {
  const Icon = ICONS[platformId] || IconYouTube
  return (
    <span className={`platform-icon platform-icon-${platformId}`} title={title}>
