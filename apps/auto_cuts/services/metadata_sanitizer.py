...
_SUBSTITUTIONS: list[tuple[str, str, str]] = [
    ...
    (r"\bxoxota\b",                        "situacao",               "all"),
    (r"\bxereca\b",                        "situacao",               "all"),
    (r"\bp[iy][ck]a\b",                    "situacao",               "all"),
    (r"\bpau\s+(?:del[ae]|do|da)\b",       "situacao de",            "all"),
    (r"\bcu(?:zinho|z[aã]o)?\b",           "situacao",               "all"),
    (r"\bgoz(ar|ou|ando)\b",               "explodir",               "all"),
    (r"\bpunhet(a|eiro)\b",                "situacao",               "all"),
    (r"\bboquete\b",                       "ato intimo",             "all"),
    (r"\btes[aã]o\b",                      "excitacao",              "all"),
    ...
    (r"\bpenis\b",                        "situation",              "all"),
    (r"\bpussy\b",                        "situation",              "all"),
    (r"\bvagina\b",                       "situation",              "all"),
    (r"\bboob(?:s)?\b",                   "situation",              "all"),
    (r"\btit(?:s)?\b",                    "situation",              "all"),
    ...
    (r"\brola\b",                         "situacao",               "title"),
    (r"\bpau\b",                          "situacao",               "title"),
